...
def hwtype_from_module(module: Mapping[str, Any]) -> str | None:
    ...
    Args:
        module: Module mapping from coordinator data.

    Returns:
        Uppercased hwtype token when present, otherwise None.
    """
...
def best_module_candidates_by_abaddr(
    ...
    *,
    ...
    Args:
        ...
        include_trident: Whether to include the `data["trident"]` container as
            a module candidate.

    Returns:
        Dict keyed by Aquabus address containing the best candidate module dict
        at that address.
    """
